...
const styles = (theme) => ({
    ...
    SubmitBtn: { backgroundColor: "#64dd17", fontSizeA: 13, marginBottom: 64, color: "black", borderRadius: 50, padding: "8px 32px", "&:hover": { background: "#64dd17" } },
                    ...
                    <Grid container direction='row' justifyContent='center'>
                        <Grid item xs={12} sm={12} md={12} lg={12}>
                            ...
                            <form className={classes.form} noValidate>
                                <Span>
                                    <Typography className={classes.Title}>Create Your Talent Account</Typography>
...
export default withStyles(styles)(SignUpTelennt);
